...
#### Traffic Platform PE : remote / Greater Seattle Area
  ...
  * Leveraging Large Language Models to automate natural language problems (e.g. user reports that need to be routed to specific teams or triaged after some basic investigation).
